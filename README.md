...
Ketika ada lebih dari satu aturan CSS yang menargetkan elemen yang sama, browser menentukan gaya yang diterapkan berdasarkan urutan prioritas (_specificity_ & _cascade_).
